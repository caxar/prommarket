                ...
                $( function() {
                    ...
                    $( "#slider-range" ).slider({
                      ...
                      slide: function( event, ui ) {
                        ...
                        $('#i-price-min-max').attr('data-min',ui.values[0]);
                        $('#i-price-min-max').attr('data-max',ui.values[1]);
                        ...
                        $.ajax({
                            method: 'GET',
                            url: '/filters',
                            data: { params: params, category_id: category_id, price_min: ui.values[0], price_max: ui.values[1] },
                    ...
                    $('#i-price-min-max').data('min',$( "#slider-range" ).slider( "values", 0 ));
                    $('#i-price-min-max').data('max',$( "#slider-range" ).slider( "values", 1 ));                      
                });
            }
        }; // Filter Price
